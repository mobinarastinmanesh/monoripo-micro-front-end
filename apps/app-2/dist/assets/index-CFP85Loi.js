...
const remotesMap = {
'app1':{url:'http://localhost:3000/dist/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const Button = lazy(() => __federation_method_getRemote("app1" , "./Button").then(module=>__federation_method_wrapDefault(module, true)));
const Input = lazy(() => __federation_method_getRemote("app1" , "./Input").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "app-title", children: "Hello from Host App" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "components-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "component-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Suspense,
        {
          fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-fallback", children: "Loading Button..." }),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", size: "md", children: "Click me!" })
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "component-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Suspense,
        {
          fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-fallback", children: "Loading Input..." }),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { variant: "filled", size: "sm" })
        }
      ) })
    ] })
  ] }) });
